...
if (isset($_SESSION['user']['id'])) {
    ...
    $standalone->redirect_to('profile');
} else {
    getPage('header');
    getPage('navbar');
    if (isset($_POST['Submit'])) {
        ...
        echo $form->zontal_input_text('username', 'text', 'form-control', 'username', 'col-sm-3', 'col-sm-9 control-label', 'Username', '');
        echo $form->zontal_input_text('password', 'password', 'form-control', 'password','col-sm-3', 'col-sm-9 control-label', 'Password', '');
        echo '
